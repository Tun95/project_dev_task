...
function ProjectDeliverablesTable() {
  ...
  // Type-safe status renderer
  const renderStatus = (status: DeliveryStatus) => (
    <Tag color={statusColors[status]} className="capitalize text-xs">
      {status}
    </Tag>
  );
    ...
    <div className="w-full">
      ...
      >
        <Table<ProjectDelivery>
          dataSource={projectDeliverables}
          ...
          {!isMobile ? (
            <>
              <Column
                ...
                key="deliverableName"
                render={(text: string, record: ProjectDelivery) => (
                  <a
                    href={record.downloadLink}
              ...
              <Column
                title="Action"
                key="action"
                render={(_, record: ProjectDelivery) => (
                  <a
                    href={record.downloadLink}
